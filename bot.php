...
if($text == '/help'){
              ...
              'caption'=>'طرق السحبب',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"𝐓𝐞𝐥𝐞", 'url'=>"https://t.me/zskkaf"]],
                       ]
                       ])
                       ]);
          	...
          	if($config['mode'] != null){
          		...
          		if($mode == 'addL'){
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                       'text'=>"𝙷𝙸 𝙱𝚁𝙾 𝙸𝙽 𝚃𝙷𝙴 𝙲𝙾𝙽𝚃𝚁𝙾𝙻 𝙱𝚈 ~ @zskkaf",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>' 👩‍🔧┇ 𝙰𝙳𝙳 𝙵𝙰𝙺𝙴 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 ','callback_data'=>'login']],
          ...
          if($data == 'login'){
        		...
        		$keyboard = ['inline_keyboard'=>[
		              ...
		              $bot->sendMessage([
		                  'chat_id'=>$chatId,
		                  'message_id'=>$mid,
		                   'text'=>" 𝙷𝙸 𝙱𝚁𝙾 𝙸𝙽 𝚃𝙷𝙴𝙰𝙲𝙲𝙾𝚄𝙽𝚃𝚂 𝙲𝙾𝙽𝚃𝚁𝙾𝙻 𝙿𝙰𝙶𝙴 𝙱𝚈 @zskkaf 𖤐",
		                  'reply_markup'=>json_encode($keyboard)
		              ]);
          } elseif($data == 'addL'){
            ...
            exec('screen -dmS gr php explore.php');
              ...
              $keyboard = ['inline_keyboard'=>[
		              ...
		              $bot->editMessageText([
		                  'chat_id'=>$chatId,
		                  'message_id'=>$mid,
		                    'text'=>" 𝙷𝙸 𝙱𝚁𝙾 𝙸𝙽 𝚃𝙷𝙴 𝙰𝙲𝙲𝙾𝚄𝙽𝚃𝚂 𝙲𝙾𝙽𝚃𝚁𝙾𝙻 𝙿𝙰𝙶𝙴 𝙱𝚈 @zskkaf 𖤐",
		                  'reply_markup'=>json_encode($keyboard)
		              ]);
          	  ...
          	  $bot->editMessageText([
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'🦯┇ 𝙶𝙴𝚃𝙸𝙽𝙶 𝚄𝚂𝙴𝚁𝚂','callback_data'=>'grabber']],
                          [['text'=>'📳┇ 𝚂𝚃𝙰𝚁𝚃 ','callback_data'=>'run'],['text'=>' 📴┇𝚂𝚃𝙾𝙿 ','callback_data'=>'stop']],
                          [['text'=>'🦸┇𝙰??𝙲𝙾𝚄𝙽𝚃𝚂 𝚂𝚃𝙰𝚃𝚄𝚂','callback_data'=>'status']],
                      ]
                    ])
                  ]);
